          ...
          <label
            ...
            >
              ...
              <div className="w-[220px] flex justify-between mt-2">
                <div
                  onClick={()=>setFormData(prev=>{return {...prev,role:"customer"}})}
                  className={`font-bold ${formData.role=="customer" ?"bg-black text-white":"text-black bg-white"} py-2 px-4 rounded-full focus:outline-none focus:shadow-outline border-2 border-gray-400 cursor-pointer`}>
                    customer
                </div>
                <div
                  onClick={()=>setFormData(prev=>{return {...prev,role:"shopkeeper"}})}
                  className={`font-bold ${formData.role=="shopkeeper" ?"bg-black text-white":"text-black bg-white"} py-2 px-4 rounded-full focus:outline-none focus:shadow-outline border-2 border-gray-400 cursor-pointer`}>
                  Shopkeeper
                </div>
              </div>
            </label>
